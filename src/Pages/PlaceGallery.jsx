...
function PlaceGallery({place}) {
          ...
          <div className='absolute inset-0 bg-black  min-h-screen text-white '>
            <div className=' bg-black p-8 grid gap-4'>
              <div>
                ...
                <button onClick={() => setShowAllPhotos(false)} className='fixed right-12 top-8   flex gap-2 py-2 px-2 rounded-2xl shadow shadow-black bg-white text-black'>
  ...
  return (
    ...
    <div className='grid gap-2 lg:grid-cols-[2fr_1fr] rounded-3xl overflow-hidden cursor-pointer '>
      <div>
        {place.photos?.[0] && (
          <div>
    ...
    <button onClick={() => setShowAllPhotos(true)} className='flex gap-1 absolute bottom-2 right-2 px-6 py-4 bg-white rounded-2xl shadow-md shadow-gray-500 '>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
